...
<header
	...
	<nav class="sm:w-1/3">
		...
		{#if menuOpen}
			<aside
				class="absolute border-t-2 border-[#424651]/[0.15] bg-[#FFF2F1] py-2 backdrop-blur-md max-sm:left-0 max-sm:mt-[0.6rem] max-sm:h-full max-sm:w-full sm:right-0 sm:mt-4 sm:h-fit sm:w-[22.222222%] sm:rounded-bl-xl sm:shadow-lg">
				<h2
...
<style>
	...
	button {
		...
		border-color: #fff2f1;
		border-radius: 100%;
		@apply transition-all delay-75 duration-200 ease-in;
	}
	nav div a:hover,
	button:hover {
		color: #759fbc;
